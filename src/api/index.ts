...
//  */
// router.post('/events/config', async (req: Request, res: Response) => {
//   try {
...
//  */
// router.patch('/events/config', async (req: Request, res: Response) => {
//   try {
//     const { deviceToken, walletAddress, events = [] } = req.body;
//     if (_.isEmpty(events)) {
//       return res.json({ status: 'success', msg: 'No events provided' });
...
//  * @param {string[]} events - a list of events a user interest.
//  */
// router.delete('/events/config', async (req: Request, res: Response) => {
//   try {
//     const { deviceToken, walletAddress, events = [] } = req.body;
//     if (_.isEmpty(events)) {
//       return res.json({ status: 'success', msg: 'No events provided' });
